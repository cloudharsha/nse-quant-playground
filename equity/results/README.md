# Equity Results Directory

This directory contains results, analysis outputs, and performance metrics from equity trading strategies and backtests.
...
### Backtest Results
`{strategy_name}_{ticker}_{date}_backtest.csv`

### Analysis Reports
`{analysis_type}_{ticker}_{date}.csv`

### Visualizations
`{chart_type}_{strategy}_{ticker}_{date}.png`
