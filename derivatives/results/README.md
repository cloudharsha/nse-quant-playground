# Derivatives Results Directory

This directory contains results, analysis outputs, and performance metrics from derivatives trading strategies and backtests.
...
### Backtest Results
`{strategy_name}_{index}_{date}_backtest.csv`

### Analysis Reports
`{analysis_type}_{index}_{date}.csv`

### Visualizations
`{chart_type}_{strategy}_{index}_{date}.png`
