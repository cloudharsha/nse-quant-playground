"""
Fetch intraday Nifty/index data using period parameter
"""
...
def get_extended_intraday_data(ticker_symbol, period='1mo', interval='5m'):
    ...
    Args:
        ticker_symbol: NSE index ticker symbol (e.g., '^NSEI')
...
def main():
    """Main function to fetch and save intraday Nifty/index data"""
    # Configuration
    ticker_symbols = [
        '^NSEI',         # Nifty 50 Index
    ...
    print("=" * 60)
    print("NSE Index/Derivatives Intraday Data Collection")
    print("=" * 60)
    ...
    # Fetch data for each index and each interval
