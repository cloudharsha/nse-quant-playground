# Commodities Python Scripts Directory

This directory contains Python scripts for fetching, processing, and analyzing commodities data.

## Available Scripts

### `fetch_commodities_data.py`

Main script for fetching historical commodities data with comprehensive technical indicators.

#### Features

- **Comprehensive data collection**: Fetches OHLCV data for major commodities
...
- **Ticker symbols**: Add/remove commodities in the `ticker_symbols` list
...
The script fetches data for major commodities:
...
- Each commodity gets its own CSV file with comprehensive indicators

## Script Structure

### Functions

- `get_commodity_data()`: Main data fetching function
...
- Real-time commodity data fetching scripts
- Multiple commodity futures contracts
- Commodity-specific analysis tools
...
- Commodity prices are in USD per standard unit